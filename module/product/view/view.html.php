...
<div id='mainContent' class="main-row">
  <div class="col-8 main-col">
    ...
    <?php if($isRoadmap):?>
      ...
      <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $product, 'div', "position=left&mode=control");?>
      <div class="col-sm-12">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="cell">
          ...
          <?php endif;?>
          <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $product, 'div', "position=right&mode=control");?>
        </div>
      </div>
    </div>
  </div>
