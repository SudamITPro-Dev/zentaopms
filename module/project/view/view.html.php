  ...
  <div id='mainContent' class="main-row">
    <div class="col-8 main-col">
      <div class="row">
        ...
        <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $project, 'div', "position=left&mode=control");?>
        <div class="col-sm-12">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="cell">
            ...
            <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $project, 'div', "position=right&mode=control");?>
          </div>
        </div>
      </div>
    </div>
