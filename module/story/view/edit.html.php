    ...
    <div class='main-row'>
      <div class='main-col col-8'>
        <div class='cell'>
          ...
          <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $story, 'div', 'position=left&mode=control');?>
          <div class='detail'>
      ...
      <div class='side-col col-4'>
        <div class='cell'>
          ...
          <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $story, 'div', 'position=right&mode=control');?>
