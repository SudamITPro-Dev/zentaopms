...
<div id="mainContent" class="main-row">
  <div class='main-col col-8'>
    ...
    <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $case, 'div', "position=left&mode=value");?>
  ...
  <div class='side-col col-4'>
    ...
    <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $case, 'div', "position=right&mode=value");?>
  </div>
</div>
