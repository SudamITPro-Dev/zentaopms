...
<div id='mainContent' class='main-row'>
  <div class="col-8 main-col">
    ...
    <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $task, 'div', "position=left&mode=value");?>
  ...
  <div class="col-4 side-col">
    ...
    <?php if(isset($this->config->bizVersion)) $this->loadModel('flow')->printFields($app->moduleName, $app->methodName, $task, 'div', "position=right&mode=value");?>
  </div>
</div>
